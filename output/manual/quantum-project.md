...
![Quantum Dependencies](https://doc.photonengine.com/docs/img/quantum/v3/manual/quantum-project/quantum-dependencies.jpg)## Quantum Hub
...
![Quantum Hub](https://doc.photonengine.com/docs/img/quantum/v3/manual/quantum-project/quantum-hub.png)## Installing The Quantum Menu
...
![Installing The Quantum Menu](https://doc.photonengine.com/docs/img/quantum/v3/manual/quantum-project/quantum-hub-menu.png)
...
![Debug Toggle](https://doc.photonengine.com/docs/img/quantum/v3/manual/quantum-project/menu-debug-toggle.png)
...
![Editor Settings - LogLevel](https://doc.photonengine.com/docs/img/quantum/v3/manual/quantum-project/editor-settings-loglevel.png)
...
![QuantumDotnetBuildSettings](https://doc.photonengine.com/docs/img/quantum/v3/manual/quantum-project/quantumdotnetbuildsettings.png)
...
![Exported Project](https://doc.photonengine.com/docs/img/quantum/v3/manual/quantum-project/exported-dotnet.png)### Exported Solution Structure
...
![export assets](https://doc.photonengine.com/docs/img/quantum/v3/manual/quantum-project/export-assets.png)
...
![File Types](https://doc.photonengine.com/docs/img/quantum/v3/manual/visual-studio-dsl-highlight.png)
...
![Visual Studio Code File Association settings](https://doc.photonengine.com/docs/img/quantum/v3/manual/visual-studio-code-dsl-highlight.png)
DSL Syntax Highlighting in .qtn files (Visual Studio).
### JetBrains Rider
...
![File Types](https://doc.photonengine.com/docs/img/quantum/v3/manual/dsl-syntax-highlighting-overview.png)
...
![New File Type](https://doc.photonengine.com/docs/img/quantum/v3/manual/dsl-syntax-highlighting-definition.png)
...
![DSL Syntax Highlighting](https://doc.photonengine.com/docs/img/quantum/v3/manual/rider-dsl-highlight.png)
