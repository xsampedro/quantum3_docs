...
```
 ...
 to keep track of the time between firing intervals when shooting.
...
```
 ...
 function to be called whenever the signal is invoked.
...
. The projectiles automatically despawn after ```
2
```
